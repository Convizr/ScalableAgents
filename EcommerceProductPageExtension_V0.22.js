export const ProductPageExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      // Outer container: max-width 600px; Media section: video on left and image column on right.
      // Details section contains the title, description, and then all the variant blocks (price box and add container).
      element.innerHTML = `
        <style>
          .product-container {
            display: flex;
