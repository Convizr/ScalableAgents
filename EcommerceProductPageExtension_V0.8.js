export const ProductPageExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      // Extract video URL (first 1080p MP4 found)
      ...
      // Extract images (up to two images)
      ...
      // Build the layout. The outer container scales responsively (100% width, max-width 800px)
      // while the details section is fixed at 500px.
      element.innerHTML = `
        <style>
          .product-container {
            display: flex;
